    ...
    methods: {
      ...
      _initCanvas() {
        let $canvas = this.$refs.canvas,
          ...
          clipperClientRect = this.$refs.clipper.getBoundingClientRect(),//getBoundingClientRect用于获取某个html元素相对于视窗的位置集合。
      ...
      _clipper() {
        ...
        try {
          imgData = this.$refs.pCanvas.toDataURL('image/jpeg', .6);//HTMLCanvasElement.toDataURL() 方法返回一个包含图片展示的 data URI  // "data:image/jpeg;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNby
        } catch (e) {
...
<style  lang="scss" src="./image-clipper.scss"></style>
